...
public class ClassEx06_연습1 {
	...
	public static void main(String[] args) {
		...
		Ex06_1 object = new Ex06_1();
		
		for (int i = 0; i < object.hgd.length; i++) {
			object.hgd[i] = ran.nextInt(5) + 1;
		}
		
		System.out.print("정답 = ");
		for (int i = 0; i < object.answer.length; i++) {
			System.out.print(object.answer[i] + " ");
		}
		System.out.println();
		
		System.out.print("학생 = ");
		for (int i = 0; i < object.hgd.length; i++) {
			System.out.print(object.hgd[i] + " ");
		}
		System.out.println();
		...
		object.score = object.answerCnt * 20;
		System.out.print("성적 = " + object.score + " 점");
